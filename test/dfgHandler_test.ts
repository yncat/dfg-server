  ...
  describe("updateHandForActivePlayer", () => {
    ...
    describe("for additionalActionControl", () => {
      it("can send CardListMessage to the active player within transfer 7 context", () => {
        ...
        const additionalActionControl = new dfg.AdditionalActionControl(
          "transfer7",
          t7action
        );
  ...
  describe("handleNextAdditionalAction", () => {
    ...
    it("handles action and returns true when transfer7 is found", () => {
      ...
      const clientIDToPlayer = sinon
        ...
        .returns(p);
      const scm1 = dfgmsg.encodeSelectableCardMessage(
        s41.ID,
        s41.mark,
        s41.cardNumber,
        false,
      ...
      const scm2 = dfgmsg.encodeSelectableCardMessage(
        s42.ID,
        s42.mark,
        s42.cardNumber,
        false,
      ...
      roomProxyMock
        .expects("send")
        .withExactArgs("ccaatt", "CardListMessage", clm);
      roomProxyMock
        .expects("broadcast")
        .withExactArgs(
          "PlayerWaitMessage",
